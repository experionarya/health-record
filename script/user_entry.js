...
function add_results() {
  ...
  httpObj.setRequestHeader('content-type','application/x-www-form-urlencoded');
  httpObj.send('uid='+get_id+'&vital_id='+vitalid+'&date='+date+'&type='+type_unit+'&read1='+read1+'&read2='+read2);
...
function add_medication() {
  ...
  httpObj.setRequestHeader('content-type','application/x-www-form-urlencoded');
  httpObj.send('uid='+get_id+'&date1='+date+'&reason='+reason+'&medication='+medication+'&dosage='+dosage);
}
